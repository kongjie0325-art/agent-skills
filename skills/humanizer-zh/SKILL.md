---
name: humanizer-zh
description: "中文文案去AI味：减少模板腔、客服腔、公告腔和过度AI润色感，让中文沟通消息更像真人自然发送。"
version: 0.1.6
author: TianyiDataScience (https://github.com/TianyiDataScience/humanize)
license: MIT
metadata:
  hermes:
    tags: [writing, editing, humanize, anti-ai-slop, chinese, text]
    category: creative
    homepage: https://github.com/TianyiDataScience/humanize
---
